...
def build_transform_gen(cfg, is_train):
    ...
    Now it includes resizing and flipping for training.
    For testing, returns an empty list to disable augmentation.
    Returns:
        list[Augmentation]
    """
    augmentation = []
...
class COCOInstanceNewBaselineDatasetMapper:
    ...
    def __call__(self, dataset_dict):
        ...
        img_a = img_cut(img_a)
        dataset_dict["image_a"] = torch.as_tensor(np.ascontiguousarray(img_a.transpose(2, 0, 1)))
