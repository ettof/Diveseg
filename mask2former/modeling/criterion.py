...
class SetCriterion(nn.Module):
    ...
    def loss_opp(self, outputs, targets, indices, num_masks):
        """Compute the deattenuate loss for I_D and I"""
        assert "OPP" in outputs
        loss_opp = self.opp_loss(outputs["OPP"], targets)
        return {"loss_opp": loss_opp}
